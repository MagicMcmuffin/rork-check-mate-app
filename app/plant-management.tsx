...
import { Wrench, Plus, Trash2, Edit2, FolderPlus, FileText, Calendar, AlertCircle, X, Check, Upload, ChevronRight, File, Image as ImageIcon, Search, Bell, Download, Eye } from 'lucide-react-native';
  ...
  const handleSaveCategory = async () => {
    ...
    try {
      if (editingCategoryId) {
        await updatePlantCategory(editingCategoryId, categoryName);
        Alert.alert('Success', 'Category updated successfully');
      } else {
        await addPlantCategory(categoryName, parentCategoryId);
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await deletePlantCategory(categoryId);
      ...
      <View style={[styles.searchContainer, { backgroundColor: colors.card, borderBottomColor: colors.border }]}>
        <View style={[styles.searchBar, { backgroundColor: colors.background, borderColor: colors.border }]}>
          ...
          <TextInput
            ...
            placeholder="Search plant by name, serial, plant #..."
        ...
        {searchQuery.trim() ? (
          ...
          <>
            <View style={styles.header}>
              ...
              <Text style={[styles.headerTitle, { color: colors.text }]}>Plant Management</Text>
            ...
            {rootCategories.length === 0 ? (
              <View style={[styles.emptyState, { backgroundColor: colors.card }]}>
                ...
                <Text style={[styles.emptyStateText, { color: colors.textSecondary }]}>
                  {isAdmin
                    ? 'Create your first category to organize plant items'
                    : 'No plant categories have been created yet'}
                </Text>
              </View>
            ) : (
          ...
          <View style={[styles.modalContainer, { backgroundColor: colors.card }]}>
            ...
            <View style={styles.modalContent}>
              ...
              <TextInput
                ...
                placeholder={parentCategoryId ? "e.g., Excavators, Dumpers, Rollers" : "e.g., Heavy Machinery, Tools"}
                placeholderTextColor={colors.textSecondary}
                value={categoryName}
